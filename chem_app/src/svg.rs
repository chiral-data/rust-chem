...
use egui::{Align2, Color32, Rect, Vec2, pos2};
...
/// A filename for a molecule, safe to put in front of a file dialog.
///
/// Dataset names come from a file's own records and can hold anything; a slash
/// would silently redirect the save, and a leading dot would hide the file.
