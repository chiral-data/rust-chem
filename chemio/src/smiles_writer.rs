...
//! ```
//!
//! or write from raw atom/bond data directly, without a [`chemcore::molecule::Molecule`]:
//!
//! ```rust
//! use chemio::smiles_writer::write_smiles;
//!
...
/// [`chemcore::molecule::Molecule`] below.
...
/// Writes a SMILES string for a [`chemcore::molecule::Molecule`], using
