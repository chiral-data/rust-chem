...
- glycine-zwitterion — nearest neighbour disagrees with rdkit: ours norbornane (t=0.133), theirs nitrobenzene (t=0.080)
- hydroxide — nearest neighbour disagrees with rdkit: ours ammonium (t=0.000), theirs kekule-cyclopentadiene (t=0.125)
