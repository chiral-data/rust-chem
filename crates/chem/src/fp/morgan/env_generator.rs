...
use crate::fp::errors::FingerprintError;
use crate::fp::fingerprint::{
    AtomEnvironment, AtomEnvironmentGenerator, FingerprintArguments, ROMol,
};
use crate::fp::hash;
use crate::fp::morgan::{MorganArguments, MorganAtomEnv};
use bitvec::prelude::*;
    ...
    fn get_environments(
        ...
        for layer in 0..morgan_args.radius {
            ...
            for atom_idx in 0..n_atoms {
                ...
                //&& atom.chiral_tag != crate::fp::fingerprint::ChiralTag::Unspecified
                {
