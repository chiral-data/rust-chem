            ...
            for (idx, atom) in mol.atoms().iter().enumerate() {
                all_atoms.push(GpuAtom {
                    ...
                    chirality: match atom.chirality() {
                        crate::core::atom::Chirality::None => 0,
                        crate::core::atom::Chirality::Unspecified => 1,
                        crate::core::atom::Chirality::CounterClockwise => 2,
            ...
            for bond in mol.bonds() {
                all_bonds.push(GpuBond {
                    ...
                    order: match bond.order() {
                        crate::core::bond::BondOrder::Single => 1,
                        crate::core::bond::BondOrder::Double => 2,
                        crate::core::bond::BondOrder::Triple => 3,
                        crate::core::bond::BondOrder::Quadruple => 4,
                        crate::core::bond::BondOrder::Aromatic => 12,
                    },
                    stereo: match bond.stereo() {
                        crate::core::bond::BondStereo::None => 0,
                        crate::core::bond::BondStereo::E => 1,
                        crate::core::bond::BondStereo::Z => 2,
                        crate::core::bond::BondStereo::Unspecified => 0,
                    },
...
mod tests {
    ...
    fn shared_test_morgan() -> Option<GpuMorganFingerprint> {
        ...
        GPU.get_or_init(|| {
            let ctx = crate::gpu::context::shared_test_context()?.clone();
