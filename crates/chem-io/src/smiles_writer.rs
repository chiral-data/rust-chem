...
//!
//! ```rust
//! use chem_io::smiles::parse_smiles;
...
//! ```
//!
//! or write from raw atom/bond data directly, without a [`chem_core::molecule::Molecule`]:
//!
//! ```rust
//! use chem_io::smiles_writer::write_smiles;
//!
...
/// [`chem_core::molecule::Molecule`] below.
...
/// Writes a SMILES string for a [`chem_core::molecule::Molecule`], using
...
mod tests {
    ...
    fn test_round_trip_smiles() {
        let test_data: Vec<&str> = vec![
            "Oc1ccccc1",
            // "Oc1cccc2ccccc12" is omitted: the parser mis-tokenizes
