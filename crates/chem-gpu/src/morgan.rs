            ...
            for (idx, atom) in mol.atoms().iter().enumerate() {
                all_atoms.push(GpuAtom {
                    ...
                    chirality: match atom.chirality() {
                        chem_core::atom::Chirality::None => 0,
                        chem_core::atom::Chirality::Unspecified => 1,
                        chem_core::atom::Chirality::CounterClockwise => 2,
                        chem_core::atom::Chirality::Clockwise => 3,
                    },
            ...
            for bond in mol.bonds() {
                all_bonds.push(GpuBond {
                    ...
                    order: match bond.order() {
                        chem_core::bond::BondOrder::Single => 1,
                        chem_core::bond::BondOrder::Double => 2,
                        chem_core::bond::BondOrder::Triple => 3,
                        chem_core::bond::BondOrder::Quadruple => 4,
                        chem_core::bond::BondOrder::Aromatic => 12,
                    },
                    stereo: match bond.stereo() {
                        chem_core::bond::BondStereo::None => 0,
                        chem_core::bond::BondStereo::E => 1,
                        chem_core::bond::BondStereo::Z => 2,
                        chem_core::bond::BondStereo::Unspecified => 0,
                    },
